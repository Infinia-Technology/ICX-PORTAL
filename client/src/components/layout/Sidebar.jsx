...
import {
  ...
  Settings, Eye, Zap, FileSpreadsheet, Package,
} from 'lucide-react';
...
const navConfig = {
  [ROLES.SUPPLIER]: [
    ...
    { label: 'GPU Capacity Listings', to: '/supplier/gpu-clusters', icon: Server },
    { section: null },
  ...
  [ROLES.CUSTOMER]: [
    ...
    { section: 'Listings' },
    { label: 'DC Listings', to: '/customer/dc-listings', icon: Building2 },
    { label: 'GPU Capacity Listings', to: '/customer/gpu-clusters', icon: Server },
    { section: 'Requests' },
    { label: 'GPU Requests', to: '/customer/gpu-demands', icon: Zap },
    { section: null },
  ...
  [ROLES.ADMIN]: [
    ...
    { label: 'GPU Capacity Listings', to: '/admin/gpu-clusters', icon: Server },
    { section: 'Requests' },
    { label: 'GPU Requests', to: '/admin/gpu-demands', icon: Zap },
    { section: null },
