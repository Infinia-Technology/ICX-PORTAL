...
// Roles an admin is allowed to assign (no superadmin, no admin)
      ...
      render: (v, row) => (
        <div className="flex gap-2">
          <Button
            size="sm"
            variant="ghost"
            onClick={() => toggleActive(v, row.isActive)}
          >
          ...
          <Button
            ...
            onClick={() => deleteUser(v, row.email)}
          >
            Delete
          </Button>
        </div>
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-[var(--color-text-secondary)] text-sm mt-1">
            Create and manage platform users — {total} user{total !== 1 ? 's' : ''}
          </p>
        </div>
