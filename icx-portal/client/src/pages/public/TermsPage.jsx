  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-16">
      ...
      <div className="prose prose-sm text-[var(--color-text-secondary)] space-y-4">
        ...
        <h2 className="text-lg font-semibold text-[var(--color-text)] mt-6">4. Data Accuracy</h2>
        <p>Users must ensure all information submitted through the platform is accurate and up to date.</p>
        <h2 className="text-lg font-semibold text-[var(--color-text)] mt-6">5. Contact</h2>
        <p>For questions about these terms, contact support@iamsaif.ai.</p>
      </div>
    </div>
  );
}
